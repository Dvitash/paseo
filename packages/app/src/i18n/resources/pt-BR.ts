...
export const ptBR: TranslationResources = {
  ...
  message: {
    ...
    dictation: {
      ...
      unavailable: "O ditado não está disponível no momento.",
    },
    question: {
      submit: "Enviar",
      next: "Próximo",
  ...
  workspace: {
    ...
    header: {
      actions: {
        ...
        saveLayoutTemplate: "Salvar layout como modelo para novos workspaces",
        clearLayoutTemplate: "Limpar modelo de layout salvo",
      },
      toasts: {
        ...
        layoutTemplateSaved: "Layout salvo — novos workspaces deste projeto abrirão com ele",
        layoutTemplateCleared: "Modelo de layout salvo foi removido",
  ...
  panels: {
    ...
    side: {
      label: "Side",
      subtitle: "Chat do Side",
      tooltip: "Chat do Side vinculado ao agente ativo",
      emptyTitle: "Nenhum agente principal selecionado",
      emptyDescription:
        "Selecione ou foque em uma aba de agente no workspace principal para conversar com o Side.",
      capabilityMissing: "Atualize o host para usar o chat do Side.",
      ...
      sendToMain: "Enviar para o principal",
      sendingToMain: "Enviando...",
      sentToMain: "Enviado para o agente principal",
      failedToSendToMain: "Falha ao enviar para o agente principal",
      retry: "Tentar novamente",
      loadError: "Falha ao carregar o chat do Side",
      userLabel: "Você",
      assistantLabel: "Side",
      providerLabel: "Provedor",
      unsupportedMainProvider:
        "O provedor do agente principal não é compatível com o Side. Escolha um provedor:",
      chooseProvider: "Escolher um provedor",
      selectProviderPrompt: "Selecione um provedor para iniciar o chat do Side",
    },
  },
  toolCallDetails: {
    error: "Erro",
  ...
  hub: {
    title: {
      sendingTo: "Enviando mensagem para {{target}}",
      sending: "Enviando mensagem",
      sentTo: "Mensagem enviada para {{target}}",
      sent: "Mensagem enviada",
      sendFailedTo: "Falha ao enviar mensagem para {{target}}",
      sendFailed: "Falha ao enviar mensagem",
      sendingInputTo: "Enviando entrada para {{target}}",
      sendingInput: "Enviando entrada",
      inputSentTo: "Entrada enviada para {{target}}",
      inputSent: "Entrada enviada",
      sendInputFailedTo: "Falha ao enviar entrada para {{target}}",
      sendInputFailed: "Falha ao enviar entrada",
      starting: "Iniciando {{target}}",
      processStarting: "Iniciando processo",
      started: "{{target}} iniciado",
      processStarted: "Processo iniciado",
      startFailed: "Falha ao iniciar {{target}}",
      processStartFailed: "Falha ao iniciar processo",
      stopping: "Parando {{target}}",
      processStopping: "Parando processo",
      stopped: "{{target}} parado",
      processStopped: "Processo parado",
      stopFailed: "Falha ao parar {{target}}",
      processStopFailed: "Falha ao parar processo",
      restarting: "Reiniciando {{target}}",
      processRestarting: "Reiniciando processo",
      restarted: "{{target}} reiniciado",
      processRestarted: "Processo reiniciado",
      restartFailed: "Falha ao reiniciar {{target}}",
      processRestartFailed: "Falha ao reiniciar processo",
      inspecting: "Inspecionando {{target}}",
      processInspecting: "Inspecionando processo",
      described: "Processo {{target}}",
      processDescribed: "Detalhes do processo",
      describeFailed: "Falha ao inspecionar {{target}}",
      processDescribeFailed: "Falha ao inspecionar processo",
      fetchingLogs: "Buscando registros de {{target}}",
      processFetchingLogs: "Buscando registros",
      logs: "Registros de {{target}}",
      processLogs: "Registros do processo",
      logsFailed: "Falha ao buscar registros de {{target}}",
      processLogsFailed: "Falha ao buscar registros",
      waitingFor: "Aguardando {{target}}",
      waiting: "Aguardando",
      waitedFor: "Espera concluída para {{target}}",
      waited: "Espera concluída",
      waitFailedFor: "Falha na espera por {{target}}",
      waitFailed: "Falha na espera",
      jobs: "Tarefas em segundo plano",
      inbox: "Caixa de entrada",
      inboxPeek: "Caixa de entrada (espiar)",
      agents: "Agentes",
      agentsFiltered: "Agentes ({{status}})",
      processes: "Processos",
      cancelling: "Cancelando {{target}}",
      cancellingJobs: "Cancelando tarefas",
      cancelled: "{{target}} cancelado",
      jobsCancelled: "Tarefas canceladas",
      cancelFailedFor: "Falha ao cancelar {{target}}",
      cancelFailed: "Falha ao cancelar tarefas",
    },
    status: {
      running: "Executando",
      completed: "Concluído",
  ...
  settings: {
    ...
    voice: {
      ...
      microphone: {
        label: "Microfone",
        description: "Entrada de áudio usada para o ditado",
        systemDefault: "Padrão do sistema",
        deviceFallback: "Microfone {{index}}",
        deviceUnavailable: "Microfone selecionado indisponível",
        accessLabel: "Acesso ao microfone",
        accessLabelsHidden: "Permita o acesso para ver os nomes dos microfones",
        accessNoDevices: "Nenhum microfone detectado",
        accessUnavailable: "A captura de áudio não está disponível aqui",
        accessError: "Não foi possível acessar o microfone: {{message}}",
        allowAccess: "Permitir acesso",
        requesting: "Solicitando...",
        managedDescription: "A entrada de áudio é gerenciada pelo sistema operacional",
      },
      dictation: {
        title: "Ditado",
        enable: "Ativar o ditado",
        ready: "Pronto",
        notReady: "Não está pronto",
        statusUnknown: "Status indisponível",
        offline: "Conecte-se a este host para configurar o ditado",
        loading: "Carregando as configurações de ditado...",
        restartRequired: "Reinicie o daemon para aplicar",
        updateRequired: "Atualize o daemon para configurar o ditado aqui",
        noHosts: "Conecte um host para configurar o ditado",
        saveFailed: "Não foi possível atualizar as configurações de ditado: {{message}}",
        provider: {
          label: "Reconhecimento de fala",
          description: "Onde o áudio do ditado é transcrito",
          local: "Neste dispositivo (Parakeet)",
          openai: "API da OpenAI",
        },
        language: {
          label: "Idioma",
          description: "Idioma falado para a transcrição",
          placeholder: "pt",
          accessibilityLabel: "Idioma do ditado",
        },
      },
    },
    notifications: {
      ...
      playSoundHint: "Reproduz um som quando um agente precisa de atenção",
      flash: "Piscar ícone do app",
      flashHint: "Pisca o ícone da barra de tarefas e o título quando um agente precisa de entrada",
    ...
    appearance: {
      ...
      hostPerformance: {
        title: "Desempenho do host",
        description: "Exibir uso de CPU, memória e GPU na barra lateral",
      },
      sidebar: {
        title: "Barra lateral",
    ...
    host: {
      webPush: {
        ...
        disabledHint:
          "Receba notificações em segundo plano quando os agentes terminarem ou precisarem de atenção.",
        unsupportedInsecure:
          "As notificações Web Push requerem um contexto seguro (HTTPS ou localhost).",
        unsupportedIos:
          "No iOS, as notificações Web Push exigem adicionar o Paseo à Tela de Início.",
        unsupportedBrowser: "Seu navegador não suporta notificações Web Push.",
        permissionDenied:
          "A permissão de notificação foi bloqueada nas configurações do seu navegador. Permita notificações para este site.",
        updateRequired:
          "Atualização do daemon do host necessária para suportar notificações Web Push.",
        disconnected: "O host está desconectado. Conecte-se para ativar as notificações.",
        enabledHint: "Notificações push em segundo plano estão ativas para este host.",
        enablingHint: "Ativando notificações Web Push…",
        disablingHint: "Desativando notificações Web Push…",
        testingHint: "Enviando notificação de teste…",
        enable: "Ativar",
        disable: "Desativar",
        testTitle: "Notificação de teste",
        testHint: "Envie uma notificação de teste para verificar o recebimento neste dispositivo.",
  ...
  hostPerformance: {
    ...
    busiestGpu: "GPU mais ocupada",
    usedOf: "{{used}} / {{total}}",
    stale: "Desatualizado",
    errorTitle: "Não foi possível carregar o desempenho do host",
    hostUnavailable: "Conecte-se a este host para ver o desempenho",
    hostUpgradeRequired: "Atualize o daemon do host para visualizar as métricas de desempenho",
    retry: "Tentar novamente",
    noGpu: "Nenhuma GPU detectada",
    gpuUnavailable: "Métricas de GPU indisponíveis",
    memoryUnavailable: "Memória indisponível",
