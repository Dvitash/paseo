...
export const ru: TranslationResources = {
  ...
  message: {
    ...
    dictation: {
      ...
      unavailable: "Диктовка сейчас недоступна.",
    },
    question: {
      submit: "Отправить",
      next: "Далее",
  ...
  workspace: {
    route: {
      ...
      recovery: {
        viewSavedChat: "Открыть сохранённый чат",
        continueElsewhere: "Продолжить в другом рабочем пространстве",
        savedChatTitle: "Сохранённый чат",
        savedChatNotice:
          "История только для чтения. Продолжение создаёт новый чат с сохранённым контекстом. Исходный чат остаётся в архиве; незакоммиченные файлы не восстанавливаются.",
        destinationWorkspace: "Целевое рабочее пространство",
        selectWorkspace: "Выберите активное рабочее пространство",
        noWorkspaces: "Нет активных пространств. Сначала откройте одно.",
        continueAction: "Создать черновик продолжения",
        emptyHistory: "Нет сохранённых сообщений.",
        loadOlder: "Загрузить предыдущие сообщения",
        historyChanged: "Сохранённая история изменилась. Повторите загрузку.",
  ...
  panels: {
    ...
    side: {
      label: "Side",
      subtitle: "Чат Side",
      tooltip: "Чат Side, связанный с активным агентом",
      emptyTitle: "Основной агент не выбран",
      emptyDescription:
        "Выберите или активируйте вкладку агента в основном рабочем пространстве для общения с Side.",
      capabilityMissing: "Обновите хост, чтобы использовать чат Side.",
      ...
      sendToMain: "Отправить в основной",
      sendingToMain: "Отправка...",
      sentToMain: "Отправлено основному агенту",
      failedToSendToMain: "Не удалось отправить основному агенту",
      retry: "Повторить",
      loadError: "Не удалось загрузить чат Side",
      userLabel: "Вы",
      assistantLabel: "Side",
      providerLabel: "Провайдер",
      unsupportedMainProvider:
        "Провайдер основного агента не поддерживается для Side. Выберите провайдера:",
      chooseProvider: "Выберите провайдера",
      selectProviderPrompt: "Выберите провайдера для начала чата Side",
    },
  },
  toolCallDetails: {
    error: "Ошибка",
  ...
  hub: {
    title: {
      sendingTo: "Отправка сообщения {{target}}",
      sending: "Отправка сообщения",
      sentTo: "Сообщение отправлено {{target}}",
      sent: "Сообщение отправлено",
      sendFailedTo: "Не удалось отправить сообщение {{target}}",
      sendFailed: "Не удалось отправить сообщение",
      sendingInputTo: "Отправка ввода в {{target}}",
      sendingInput: "Отправка ввода",
      inputSentTo: "Ввод отправлен в {{target}}",
      inputSent: "Ввод отправлен",
      sendInputFailedTo: "Не удалось отправить ввод в {{target}}",
      sendInputFailed: "Не удалось отправить ввод",
      starting: "Запуск {{target}}",
      processStarting: "Запуск процесса",
      started: "{{target}} запущен",
      processStarted: "Процесс запущен",
      startFailed: "Не удалось запустить {{target}}",
      processStartFailed: "Не удалось запустить процесс",
      stopping: "Остановка {{target}}",
      processStopping: "Остановка процесса",
      stopped: "{{target}} остановлен",
      processStopped: "Процесс остановлен",
      stopFailed: "Не удалось остановить {{target}}",
      processStopFailed: "Не удалось остановить процесс",
      restarting: "Перезапуск {{target}}",
      processRestarting: "Перезапуск процесса",
      restarted: "{{target}} перезапущен",
      processRestarted: "Процесс перезапущен",
      restartFailed: "Не удалось перезапустить {{target}}",
      processRestartFailed: "Не удалось перезапустить процесс",
      inspecting: "Проверка {{target}}",
      processInspecting: "Проверка процесса",
      described: "Процесс {{target}}",
      processDescribed: "Сведения о процессе",
      describeFailed: "Не удалось проверить {{target}}",
      processDescribeFailed: "Не удалось проверить процесс",
      fetchingLogs: "Получение журналов {{target}}",
      processFetchingLogs: "Получение журналов",
      logs: "Журналы {{target}}",
      processLogs: "Журналы процесса",
      logsFailed: "Не удалось получить журналы {{target}}",
      processLogsFailed: "Не удалось получить журналы",
      waitingFor: "Ожидание {{target}}",
      waiting: "Ожидание",
      waitedFor: "Ожидание {{target}} завершено",
      waited: "Ожидание завершено",
      waitFailedFor: "Ошибка ожидания {{target}}",
      waitFailed: "Ошибка ожидания",
      jobs: "Фоновые задачи",
      inbox: "Входящие",
      inboxPeek: "Входящие (просмотр)",
      agents: "Агенты",
      agentsFiltered: "Агенты ({{status}})",
      processes: "Процессы",
      cancelling: "Отмена {{target}}",
      cancellingJobs: "Отмена задач",
      cancelled: "{{target}} отменен",
      jobsCancelled: "Задачи отменены",
      cancelFailedFor: "Не удалось отменить {{target}}",
      cancelFailed: "Не удалось отменить задачи",
    },
    status: {
      running: "Выполняется",
      completed: "Завершено",
      ...
      ready: "Готово",
      stopped: "Остановлено",
      noResultYet: "Результатов пока нет",
    },
  },
  toolCallGroup: {
    editedFiles: {
  ...
  settings: {
    ...
    voice: {
      ...
      microphone: {
        label: "Микрофон",
        description: "Аудиовход, используемый для диктовки",
        systemDefault: "Системный по умолчанию",
        deviceFallback: "Микрофон {{index}}",
        deviceUnavailable: "Выбранный микрофон недоступен",
        accessLabel: "Доступ к микрофону",
        accessLabelsHidden: "Разрешите доступ, чтобы увидеть названия микрофонов",
        accessNoDevices: "Микрофон не обнаружен",
        accessUnavailable: "Запись звука здесь недоступна",
        accessError: "Не удалось получить доступ к микрофону: {{message}}",
        allowAccess: "Разрешить доступ",
        requesting: "Запрос...",
        managedDescription: "Аудиовходом управляет операционная система",
      },
      dictation: {
        title: "Диктовка",
        enable: "Включить диктовку",
        ready: "Готово",
        notReady: "Не готова",
        statusUnknown: "Состояние недоступно",
        offline: "Подключитесь к этому хосту, чтобы настроить диктовку",
        loading: "Загрузка настроек диктовки...",
        restartRequired: "Перезапустите демон, чтобы применить",
        updateRequired: "Обновите демон, чтобы настроить диктовку здесь",
        noHosts: "Подключите хост, чтобы настроить диктовку",
        saveFailed: "Не удалось обновить настройки диктовки: {{message}}",
        provider: {
          label: "Распознавание речи",
          description: "Где расшифровывается звук диктовки",
          local: "На этом устройстве (Parakeet)",
          openai: "OpenAI API",
        },
        language: {
          label: "Язык",
          description: "Разговорный язык для расшифровки",
          placeholder: "ru",
          accessibilityLabel: "Язык диктовки",
        },
      },
    },
    notifications: {
      ...
      playSoundHint: "Воспроизводит звук, когда агенту требуется внимание",
      flash: "Мигать значком приложения",
      flashHint: "Мигает значком на панели задач и заголовком, когда агенту нужен ввод",
    ...
    host: {
      webPush: {
        ...
        disabledHint:
          "Получайте фоновые уведомления, когда агенты завершают работу или требуют внимания.",
        unsupportedInsecure:
          "Для Web Push-уведомлений требуется безопасный контекст (HTTPS или localhost).",
        unsupportedIos:
          "На iOS для Web Push-уведомлений требуется добавить Paseo на экран «Домой».",
        unsupportedBrowser: "Ваш браузер не поддерживает Web Push-уведомления.",
        permissionDenied:
          "Разрешение на уведомления заблокировано в настройках браузера. Разрешите уведомления для этого сайта.",
        updateRequired: "Требуется обновление демона хоста для поддержки Web Push-уведомлений.",
        disconnected: "Хост отключен. Подключитесь, чтобы включить уведомления.",
        enabledHint: "Фоновые push-уведомления активны для этого хоста.",
        enablingHint: "Включение Web Push-уведомлений…",
        disablingHint: "Отключение Web Push-уведомлений…",
        testingHint: "Отправка тестового уведомления…",
        enable: "Включить",
        disable: "Отключить",
        testTitle: "Тестовое уведомление",
        testHint: "Отправьте тестовое уведомление для проверки доставки на этом устройстве.",
  ...
  tokenUsage: {
    ...
    refresh: "Обновить",
    refreshing: "Обновление...",
    loading: "Загрузка использования токенов...",
    empty: "Нет данных об использовании токенов",
    unavailable: "Телеметрия использования токенов недоступна на этом хосте",
