...
export const zhCN: TranslationResources = {
  ...
  workspace: {
    ...
    header: {
      actions: {
        ...
        copyBranchName: "复制分支名称",
        showSetup: "显示 setup",
        saveLayoutTemplate: "将布局保存为新工作区的模板",
        clearLayoutTemplate: "清除已保存的布局模板",
      },
      toasts: {
        workspacePathUnavailable: "Workspace 路径尚不可用",
        branchNameUnavailable: "分支名称不可用",
        layoutTemplateSaved: "布局已保存 — 此项目的新工作区将以该布局打开",
        layoutTemplateCleared: "已清除保存的布局模板",
  ...
  panels: {
    ...
    side: {
      label: "Side",
      subtitle: "Side 对话",
      tooltip: "与当前活跃 agent 关联的 Side 对话",
      emptyTitle: "未选择主 agent",
      emptyDescription: "在主工作区中选择或聚焦某个 agent 标签页以开始与 Side 对话。",
      capabilityMissing: "请更新主机以使用 Side 对话。",
      linkedTo: "已关联至 {{title}}",
      ...
      sendToMain: "发送给主 agent",
      sendingToMain: "发送中...",
      sentToMain: "已发送给主 agent",
      failedToSendToMain: "发送给主 agent 失败",
      retry: "重试",
      loadError: "加载 Side 对话失败",
      userLabel: "你",
      assistantLabel: "Side",
      providerLabel: "模型提供商",
      unsupportedMainProvider: "主 agent 的模型提供商不受 Side 支持。请选择一个提供商：",
      chooseProvider: "选择提供商",
      selectProviderPrompt: "请选择一个提供商以启动 Side 对话",
    },
  },
  toolCallDetails: {
    error: "错误",
  ...
  hub: {
    title: {
      sendingTo: "正在向 {{target}} 发送消息",
      sending: "正在发送消息",
      sentTo: "已向 {{target}} 发送消息",
      sent: "消息已发送",
      sendFailedTo: "向 {{target}} 发送消息失败",
      sendFailed: "发送消息失败",
      sendingInputTo: "正在向 {{target}} 发送输入",
      sendingInput: "正在发送输入",
      inputSentTo: "已向 {{target}} 发送输入",
      inputSent: "输入已发送",
      sendInputFailedTo: "向 {{target}} 发送输入失败",
      sendInputFailed: "发送输入失败",
      starting: "正在启动 {{target}}",
      processStarting: "正在启动进程",
      started: "已启动 {{target}}",
      processStarted: "进程已启动",
      startFailed: "启动 {{target}} 失败",
      processStartFailed: "启动进程失败",
      stopping: "正在停止 {{target}}",
      processStopping: "正在停止进程",
      stopped: "已停止 {{target}}",
      processStopped: "进程已停止",
      stopFailed: "停止 {{target}} 失败",
      processStopFailed: "停止进程失败",
      restarting: "正在重启 {{target}}",
      processRestarting: "正在重启进程",
      restarted: "已重启 {{target}}",
      processRestarted: "进程已重启",
      restartFailed: "重启 {{target}} 失败",
      processRestartFailed: "重启进程失败",
      inspecting: "正在检查 {{target}}",
      processInspecting: "正在检查进程",
      described: "进程 {{target}}",
      processDescribed: "进程详情",
      describeFailed: "检查 {{target}} 失败",
      processDescribeFailed: "检查进程失败",
      fetchingLogs: "正在获取 {{target}} 的日志",
      processFetchingLogs: "正在获取日志",
      logs: "{{target}} 的日志",
      processLogs: "进程日志",
      logsFailed: "获取 {{target}} 的日志失败",
      processLogsFailed: "获取日志失败",
      waitingFor: "正在等待 {{target}}",
      waiting: "正在等待",
      waitedFor: "等待 {{target}} 完成",
      waited: "等待完成",
      waitFailedFor: "等待 {{target}} 失败",
      waitFailed: "等待失败",
      jobs: "后台任务",
      inbox: "收件箱",
      inboxPeek: "收件箱 (查看)",
      agents: "代理",
      agentsFiltered: "代理 ({{status}})",
      processes: "进程",
      cancelling: "正在取消 {{target}}",
      cancellingJobs: "正在取消任务",
      cancelled: "已取消 {{target}}",
      jobsCancelled: "任务已取消",
      cancelFailedFor: "取消 {{target}} 失败",
      cancelFailed: "取消任务失败",
    },
    status: {
      running: "运行中",
  ...
  settings: {
    ...
    voice: {
      ...
      microphone: {
        label: "麦克风",
        description: "用于听写的音频输入",
        systemDefault: "系统默认",
        deviceFallback: "麦克风 {{index}}",
        deviceUnavailable: "所选麦克风不可用",
        accessLabel: "麦克风权限",
        accessLabelsHidden: "允许访问以查看麦克风名称",
        accessNoDevices: "未检测到麦克风",
        accessUnavailable: "此处无法采集音频",
        accessError: "无法访问麦克风：{{message}}",
        allowAccess: "允许访问",
        requesting: "请求中...",
        managedDescription: "音频输入由操作系统管理",
      },
      dictation: {
        title: "听写",
        enable: "启用听写",
        ...
        offline: "连接此主机以配置听写",
        loading: "正在加载听写设置...",
        restartRequired: "重启守护进程以应用",
        updateRequired: "更新守护进程以在此配置听写",
        noHosts: "连接主机以配置听写",
        saveFailed: "无法更新听写设置：{{message}}",
        provider: {
          label: "语音识别",
          description: "听写音频的转写位置",
          local: "本机（Parakeet）",
          openai: "OpenAI API",
        },
        language: {
          label: "语言",
          description: "用于转写的口语语言",
          placeholder: "zh",
    ...
    notifications: {
      ...
      playSound: "播放声音",
      playSoundHint: "当代理需要注意时播放声音",
      flash: "闪烁应用图标",
      flashHint: "当代理需要输入时闪烁任务栏图标和标题",
      test: "测试通知",
    ...
    appearance: {
      ...
      hostPerformance: {
        title: "主机性能",
        description: "在侧边栏中显示 CPU、内存和 GPU 使用率",
      },
      sidebar: {
        title: "侧边栏",
  ...
  hostPerformance: {
    ...
    stale: "已过期",
    errorTitle: "无法加载主机性能",
    hostUnavailable: "连接到此主机以查看性能",
    hostUpgradeRequired: "请更新主机守护程序以查看性能指标",
    retry: "重试",
    noGpu: "未检测到 GPU",
    gpuUnavailable: "GPU 指标不可用",
    memoryUnavailable: "内存不可用",
