...
export const fr: TranslationResources = {
  ...
  panels: {
    ...
    side: {
      label: "Side",
      subtitle: "Discussion Side",
      tooltip: "Discussion Side liée à l'agent actif",
      emptyTitle: "Aucun agent principal sélectionné",
      emptyDescription:
        "Sélectionnez ou activez un onglet d'agent dans l'espace de travail principal pour discuter avec Side.",
      capabilityMissing: "Mettez à jour l'hôte pour utiliser la discussion Side.",
      linkedTo: "Lié à {{title}}",
      untitledAgent: "Agent sans titre",
      inputPlaceholder: "Interrogez Side sur cette session...",
      send: "Envoyer",
      statusUpdate: "Mise à jour du statut",
      stop: "Arrêter",
      running: "L'agent Side travaille...",
      proposedSteering: "Orientation proposée pour l'agent principal",
      sendToMain: "Envoyer au principal",
      sendingToMain: "Envoi en cours...",
      sentToMain: "Envoyé à l'agent principal",
      failedToSendToMain: "Échec de l'envoi à l'agent principal",
      retry: "Réessayer",
      loadError: "Échec du chargement de la discussion Side",
      userLabel: "Vous",
      assistantLabel: "Side",
      providerLabel: "Fournisseur",
      unsupportedMainProvider:
        "Le fournisseur de l'agent principal n'est pas pris en charge pour Side. Choisissez un fournisseur :",
      chooseProvider: "Choisir un fournisseur",
      selectProviderPrompt: "Sélectionnez un fournisseur pour démarrer la discussion Side",
    },
  },
  toolCallDetails: {
    error: "Erreur",
  ...
  hub: {
    title: {
      sendingTo: "Envoi du message à {{target}}",
      sending: "Envoi du message",
      sentTo: "Message envoyé à {{target}}",
      sent: "Message envoyé",
      sendFailedTo: "Échec de l'envoi du message à {{target}}",
      sendFailed: "Échec de l'envoi du message",
      sendingInputTo: "Envoi de l'entrée à {{target}}",
      sendingInput: "Envoi de l'entrée",
      inputSentTo: "Entrée envoyée à {{target}}",
      inputSent: "Entrée envoyée",
      sendInputFailedTo: "Échec de l'envoi de l'entrée à {{target}}",
      sendInputFailed: "Échec de l'envoi de l'entrée",
      starting: "Démarrage de {{target}}",
      processStarting: "Démarrage du processus",
      started: "{{target}} démarré",
      processStarted: "Processus démarré",
      startFailed: "Échec du démarrage de {{target}}",
      processStartFailed: "Échec du démarrage du processus",
      stopping: "Arrêt de {{target}}",
      processStopping: "Arrêt du processus",
      stopped: "{{target}} arrêté",
      processStopped: "Processus arrêté",
      stopFailed: "Échec de l'arrêt de {{target}}",
      processStopFailed: "Échec de l'arrêt du processus",
      restarting: "Redémarrage de {{target}}",
      processRestarting: "Redémarrage du processus",
      restarted: "{{target}} redémarré",
      processRestarted: "Processus redémarré",
      restartFailed: "Échec du redémarrage de {{target}}",
      processRestartFailed: "Échec du redémarrage du processus",
      inspecting: "Inspection de {{target}}",
      processInspecting: "Inspection du processus",
      described: "Processus {{target}}",
      processDescribed: "Détails du processus",
      describeFailed: "Échec de l'inspection de {{target}}",
      processDescribeFailed: "Échec de l'inspection du processus",
      fetchingLogs: "Récupération des journaux de {{target}}",
      processFetchingLogs: "Récupération des journaux",
      logs: "Journaux de {{target}}",
      processLogs: "Journaux du processus",
      logsFailed: "Échec de la récupération des journaux de {{target}}",
      processLogsFailed: "Échec de la récupération des journaux",
      waitingFor: "En attente de {{target}}",
      waiting: "En attente",
      waitedFor: "Attente terminée pour {{target}}",
      waited: "Attente terminée",
      waitFailedFor: "Échec de l'attente de {{target}}",
      waitFailed: "Échec de l'attente",
      jobs: "Tâches de fond",
      inbox: "Boîte de réception",
      inboxPeek: "Boîte de réception (aperçu)",
      agents: "Agents",
      agentsFiltered: "Agents ({{status}})",
      processes: "Processus",
      cancelling: "Annulation de {{target}}",
      cancellingJobs: "Annulation des tâches",
      cancelled: "{{target}} annulé",
      jobsCancelled: "Tâches annulées",
      cancelFailedFor: "Échec de l'annulation de {{target}}",
      cancelFailed: "Échec de l'annulation des tâches",
    },
    status: {
      running: "En cours",
      completed: "Terminé",
  ...
  settings: {
    ...
    voice: {
      ...
      microphone: {
        label: "Microphone",
        description: "Entrée audio utilisée pour la dictée",
        systemDefault: "Par défaut du système",
        deviceFallback: "Microphone {{index}}",
        deviceUnavailable: "Microphone sélectionné indisponible",
        accessLabel: "Accès au microphone",
        accessLabelsHidden: "Autorisez l'accès pour voir les noms des microphones",
        accessNoDevices: "Aucun microphone détecté",
        accessUnavailable: "La capture audio n'est pas disponible ici",
        accessError: "Impossible d'accéder au microphone : {{message}}",
        allowAccess: "Autoriser l'accès",
        requesting: "Demande en cours...",
        managedDescription: "L'entrée audio est gérée par le système d'exploitation",
      },
      dictation: {
        title: "Dictée",
        enable: "Activer la dictée",
        ready: "Prêt",
        notReady: "Non prêt",
        statusUnknown: "État indisponible",
        offline: "Connectez-vous à cet hôte pour configurer la dictée",
        loading: "Chargement des réglages de dictée...",
        restartRequired: "Redémarrez le démon pour appliquer",
        updateRequired: "Mettez à jour le démon pour configurer la dictée ici",
        noHosts: "Connectez un hôte pour configurer la dictée",
        saveFailed: "Impossible de mettre à jour la dictée : {{message}}",
        provider: {
          label: "Reconnaissance vocale",
          description: "Où l'audio de dictée est transcrit",
          local: "Sur cet appareil (Parakeet)",
          openai: "API OpenAI",
        },
        language: {
          label: "Langue",
          description: "Langue parlée pour la transcription",
          placeholder: "fr",
          accessibilityLabel: "Langue de dictée",
        },
      },
    },
    notifications: {
