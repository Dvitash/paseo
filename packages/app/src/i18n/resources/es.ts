...
export const es: TranslationResources = {
  ...
  newWorkspace: {
    ...
    worktreeName: {
      label: "Nombre del worktree",
      placeholder: "Nombre del worktree (opcional)",
    },
    fields: {
      project: "Proyecto",
      base: "Base",
  ...
  panels: {
    ...
    side: {
      label: "Side",
      subtitle: "Chat de Side",
      tooltip: "Chat de Side vinculado al agente activo",
      emptyTitle: "Ningún agente principal seleccionado",
      emptyDescription:
        "Selecciona o enfoca una pestaña de agente en el workspace principal para chatear con Side.",
      capabilityMissing: "Actualiza el host para usar el chat de Side.",
      ...
      sendToMain: "Enviar al principal",
      sendingToMain: "Enviando...",
      sentToMain: "Enviado al agente principal",
      failedToSendToMain: "Error al enviar al agente principal",
      retry: "Reintentar",
      loadError: "Error al cargar el chat de Side",
      userLabel: "Tú",
      assistantLabel: "Side",
      providerLabel: "Proveedor",
      unsupportedMainProvider:
        "El proveedor del agente principal no es compatible con Side. Elige un proveedor:",
      chooseProvider: "Elegir un proveedor",
      selectProviderPrompt: "Selecciona un proveedor para iniciar el chat de Side",
    },
  },
  toolCallDetails: {
    error: "Error",
  ...
  hub: {
    title: {
      sendingTo: "Enviando mensaje a {{target}}",
      sending: "Enviando mensaje",
      sentTo: "Mensaje enviado a {{target}}",
      sent: "Mensaje enviado",
      sendFailedTo: "Error al enviar mensaje a {{target}}",
      sendFailed: "Error al enviar mensaje",
      sendingInputTo: "Enviando entrada a {{target}}",
      sendingInput: "Enviando entrada",
      inputSentTo: "Entrada enviada a {{target}}",
      inputSent: "Entrada enviada",
      sendInputFailedTo: "Error al enviar entrada a {{target}}",
      sendInputFailed: "Error al enviar entrada",
      starting: "Iniciando {{target}}",
      processStarting: "Iniciando proceso",
      started: "Iniciado {{target}}",
      processStarted: "Proceso iniciado",
      startFailed: "Error al iniciar {{target}}",
      processStartFailed: "Error al iniciar el proceso",
      stopping: "Deteniendo {{target}}",
      processStopping: "Deteniendo proceso",
      stopped: "Detenido {{target}}",
      processStopped: "Proceso detenido",
      stopFailed: "Error al detener {{target}}",
      processStopFailed: "Error al detener el proceso",
      restarting: "Reiniciando {{target}}",
      processRestarting: "Reiniciando proceso",
      restarted: "Reiniciado {{target}}",
      processRestarted: "Proceso reiniciado",
      restartFailed: "Error al reiniciar {{target}}",
      processRestartFailed: "Error al reiniciar el proceso",
      inspecting: "Inspeccionando {{target}}",
      processInspecting: "Inspeccionando proceso",
      described: "Proceso {{target}}",
      processDescribed: "Detalles del proceso",
      describeFailed: "Error al inspeccionar {{target}}",
      processDescribeFailed: "Error al inspeccionar el proceso",
      fetchingLogs: "Obteniendo registros de {{target}}",
      processFetchingLogs: "Obteniendo registros",
      logs: "Registros de {{target}}",
      processLogs: "Registros del proceso",
      logsFailed: "Error al obtener registros de {{target}}",
      processLogsFailed: "Error al obtener registros",
      waitingFor: "Esperando a {{target}}",
      waiting: "Esperando",
      waitedFor: "Espera completada para {{target}}",
      waited: "Espera completada",
      waitFailedFor: "Error en la espera de {{target}}",
      waitFailed: "Error en la espera",
      jobs: "Trabajos en segundo plano",
      inbox: "Bandeja de entrada",
      inboxPeek: "Bandeja de entrada (inspeccionar)",
      agents: "Agentes",
      agentsFiltered: "Agentes ({{status}})",
      processes: "Procesos",
      cancelling: "Cancelando {{target}}",
      cancellingJobs: "Cancelando trabajos",
      cancelled: "{{target}} cancelado",
      jobsCancelled: "Trabajos cancelados",
      cancelFailedFor: "Error al cancelar {{target}}",
      cancelFailed: "Error al cancelar trabajos",
    },
    status: {
  ...
  settings: {
    ...
    voice: {
      ...
      microphone: {
        label: "Micrófono",
        description: "Entrada de audio usada para el dictado",
        systemDefault: "Predeterminado del sistema",
        deviceFallback: "Micrófono {{index}}",
        deviceUnavailable: "El micrófono seleccionado no está disponible",
        accessLabel: "Acceso al micrófono",
        accessLabelsHidden: "Permite el acceso para ver los nombres de los micrófonos",
        accessNoDevices: "No se detectó ningún micrófono",
        accessUnavailable: "La captura de audio no está disponible aquí",
        accessError: "No se pudo acceder al micrófono: {{message}}",
        allowAccess: "Permitir acceso",
        requesting: "Solicitando...",
        managedDescription: "El sistema operativo gestiona la entrada de audio",
      },
      dictation: {
        title: "Dictado",
        enable: "Activar el dictado",
        ready: "Listo",
        notReady: "No está listo",
        statusUnknown: "Estado no disponible",
        offline: "Conéctate a este host para configurar el dictado",
        loading: "Cargando la configuración del dictado...",
        restartRequired: "Reinicia el daemon para aplicar los cambios",
        updateRequired: "Actualiza el daemon para configurar el dictado aquí",
        noHosts: "Conecta un host para configurar el dictado",
        saveFailed: "No se pudo actualizar la configuración del dictado: {{message}}",
        provider: {
          label: "Reconocimiento de voz",
          description: "Dónde se transcribe el audio del dictado",
          local: "En este dispositivo (Parakeet)",
          openai: "API de OpenAI",
        },
        language: {
          label: "Idioma",
          description: "Idioma hablado para la transcripción",
          placeholder: "es",
          accessibilityLabel: "Idioma del dictado",
        },
      },
    },
    notifications: {
