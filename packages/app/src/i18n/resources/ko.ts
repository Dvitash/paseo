...
export const ko: TranslationResources = {
  ...
  message: {
    ...
    dictation: {
      ...
      unavailable: "지금은 받아쓰기를 사용할 수 없습니다.",
    },
    question: {
      submit: "제출",
      next: "다음",
  ...
  panels: {
    ...
    side: {
      label: "Side",
      subtitle: "Side 채팅",
      tooltip: "활성 에이전트와 연결된 Side 채팅",
      emptyTitle: "선택된 메인 에이전트 없음",
      emptyDescription:
        "Side와 대화하려면 메인 워크스페이스에서 에이전트 탭을 선택하거나 포커스하세요.",
      capabilityMissing: "Side 채팅을 사용하려면 호스트를 업데이트하세요.",
      linkedTo: "{{title}}에 연결됨",
      ...
      sendToMain: "메인으로 전송",
      sendingToMain: "전송 중...",
      sentToMain: "메인 에이전트로 전송됨",
      failedToSendToMain: "메인 에이전트 전송 실패",
      retry: "다시 시도",
      loadError: "Side 채팅을 불러오지 못했습니다",
      userLabel: "나",
      assistantLabel: "Side",
      providerLabel: "제공자",
      unsupportedMainProvider:
        "메인 에이전트의 제공자는 Side에서 지원되지 않습니다. 제공자를 선택하세요:",
      chooseProvider: "제공자 선택",
      selectProviderPrompt: "Side 채팅을 시작할 제공자를 선택하세요",
    },
  },
  toolCallDetails: {
    error: "오류",
  ...
  hub: {
    title: {
      sendingTo: "{{target}}에게 메시지 전송 중",
      sending: "메시지 전송 중",
      sentTo: "{{target}}에게 메시지 전송됨",
      sent: "메시지 전송됨",
      sendFailedTo: "{{target}}에게 메시지 전송 실패",
      sendFailed: "메시지 전송 실패",
      sendingInputTo: "{{target}}에 입력 전송 중",
      sendingInput: "입력 전송 중",
      inputSentTo: "{{target}}에 입력 전송됨",
      inputSent: "입력 전송됨",
      sendInputFailedTo: "{{target}}에 입력 전송 실패",
      sendInputFailed: "입력 전송 실패",
      starting: "{{target}} 시작 중",
      processStarting: "프로세스 시작 중",
      started: "{{target}} 시작됨",
      processStarted: "프로세스 시작됨",
      startFailed: "{{target}} 시작 실패",
      processStartFailed: "프로세스 시작 실패",
      stopping: "{{target}} 중지 중",
      processStopping: "프로세스 중지 중",
      stopped: "{{target}} 중지됨",
      processStopped: "프로세스 중지됨",
      stopFailed: "{{target}} 중지 실패",
      processStopFailed: "프로세스 중지 실패",
      restarting: "{{target}} 재시작 중",
      processRestarting: "프로세스 재시작 중",
      restarted: "{{target}} 재시작됨",
      processRestarted: "프로세스 재시작됨",
      restartFailed: "{{target}} 재시작 실패",
      processRestartFailed: "프로세스 재시작 실패",
      inspecting: "{{target}} 검사 중",
      processInspecting: "프로세스 검사 중",
      described: "프로세스 {{target}}",
      processDescribed: "프로세스 세부 정보",
      describeFailed: "{{target}} 검사 실패",
      processDescribeFailed: "프로세스 검사 실패",
      fetchingLogs: "{{target}}에서 로그 가져오는 중",
      processFetchingLogs: "로그 가져오는 중",
      logs: "{{target}} 로그",
      processLogs: "프로세스 로그",
      logsFailed: "{{target}} 로그 가져오기 실패",
      processLogsFailed: "로그 가져오기 실패",
      waitingFor: "{{target}} 대기 중",
      waiting: "대기 중",
      waitedFor: "{{target}} 대기 완료",
      waited: "대기 완료",
      waitFailedFor: "{{target}} 대기 실패",
      waitFailed: "대기 실패",
      jobs: "백그라운드 작업",
      inbox: "받은 편지함",
      inboxPeek: "받은 편지함 (미리보기)",
      agents: "에이전트",
      agentsFiltered: "에이전트 ({{status}})",
      processes: "프로세스",
      cancelling: "{{target}} 취소 중",
      cancellingJobs: "작업 취소 중",
      cancelled: "{{target}} 취소됨",
      jobsCancelled: "작업 취소됨",
      cancelFailedFor: "{{target}} 취소 실패",
  ...
  settings: {
    ...
    voice: {
      ...
      microphone: {
        label: "마이크",
        description: "받아쓰기에 사용하는 오디오 입력",
        systemDefault: "시스템 기본값",
        deviceFallback: "마이크 {{index}}",
        deviceUnavailable: "선택한 마이크를 사용할 수 없습니다",
        accessLabel: "마이크 접근",
        accessLabelsHidden: "마이크 이름을 보려면 접근을 허용하세요",
        accessNoDevices: "마이크를 찾을 수 없습니다",
        accessUnavailable: "이 환경에서는 오디오 캡처를 사용할 수 없습니다",
        accessError: "마이크에 접근할 수 없습니다: {{message}}",
        allowAccess: "접근 허용",
        requesting: "요청 중...",
        managedDescription: "오디오 입력은 운영 체제에서 관리합니다",
      },
      dictation: {
        title: "받아쓰기",
        enable: "받아쓰기 활성화",
        ...
        offline: "받아쓰기를 설정하려면 이 호스트에 연결하세요",
        loading: "받아쓰기 설정을 불러오는 중...",
        restartRequired: "적용하려면 데몬을 다시 시작하세요",
        updateRequired: "여기에서 받아쓰기를 설정하려면 데몬을 업데이트하세요",
        noHosts: "받아쓰기를 설정하려면 호스트에 연결하세요",
        saveFailed: "받아쓰기 설정을 업데이트할 수 없습니다: {{message}}",
        provider: {
          label: "음성 인식",
          description: "받아쓰기 오디오를 변환하는 위치",
          local: "이 기기에서(Parakeet)",
          openai: "OpenAI API",
        },
        language: {
          label: "언어",
          description: "변환에 사용할 말하는 언어",
          placeholder: "ko",
          accessibilityLabel: "받아쓰기 언어",
        },
      },
    },
    notifications: {
      ...
      playSound: "소리 재생",
      playSoundHint: "에이전트가 주의를 필요로 할 때 소리를 재생합니다",
      flash: "앱 아이콘 깜박임",
      flashHint: "에이전트가 입력을 필요로 할 때 작업 표시줄 아이콘과 제목을 깜박입니다",
      test: "알림 테스트",
    ...
    appearance: {
      ...
      hostPerformance: {
        title: "호스트 성능",
        description: "사이드바에 CPU, 메모리, GPU 사용량을 표시합니다",
      },
      sidebar: {
        title: "사이드바",
  ...
  hostPerformance: {
    ...
    ram: "RAM",
    devices: "{{count}}개 장치",
    busiestGpu: "가장 바쁜 GPU",
    usedOf: "{{used}} / {{total}}",
    stale: "오래됨",
    errorTitle: "호스트 성능을 불러올 수 없습니다",
    hostUnavailable: "성능을 확인하려면 이 호스트에 연결하세요",
    hostUpgradeRequired: "성능 지표를 보려면 호스트 데몬을 업데이트하세요",
    retry: "다시 시도",
    noGpu: "GPU가 감지되지 않음",
    gpuUnavailable: "GPU 지표를 사용할 수 없음",
    memoryUnavailable: "메모리를 사용할 수 없음",
