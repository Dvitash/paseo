...
export const ar: TranslationResources = {
  ...
  message: {
    ...
    dictation: {
      ...
      unavailable: "الإملاء غير متاح حاليًا.",
    },
    question: {
      submit: "يُقدِّم",
      next: "التالي",
  ...
  panels: {
    ...
    side: {
      label: "Side",
      subtitle: "محادثة Side",
      tooltip: "محادثة Side مرتبطة بالوكيل النشط",
      emptyTitle: "لم يتم تحديد وكيل رئيسي",
      emptyDescription:
        "حدد أو ركّز على علامة تبويب الوكيل في مساحة العمل الرئيسية للمحادثة مع Side.",
      capabilityMissing: "حدّث المضيف لاستخدام محادثة Side.",
      linkedTo: "مرتبط بـ {{title}}",
      ...
      sendToMain: "إرسال إلى الرئيسي",
      sendingToMain: "جارٍ الإرسال...",
      sentToMain: "تم الإرسال إلى الوكيل الرئيسي",
      failedToSendToMain: "فشل الإرسال إلى الوكيل الرئيسي",
      retry: "إعادة المحاولة",
      loadError: "فشل تحميل محادثة Side",
      userLabel: "أنت",
      assistantLabel: "Side",
      providerLabel: "المزود",
      unsupportedMainProvider: "مزود الوكيل الرئيسي غير مدعوم لـ Side. اختر مزودًا:",
      chooseProvider: "اختر مزودًا",
      selectProviderPrompt: "اختر مزودًا لبدء محادثة Side",
    },
  },
  toolCallDetails: {
    error: "خطأ",
  ...
  hub: {
    title: {
      sendingTo: "جارٍ إرسال رسالة إلى {{target}}",
      sending: "جارٍ إرسال رسالة",
      sentTo: "تم إرسال الرسالة إلى {{target}}",
      sent: "تم إرسال الرسالة",
      sendFailedTo: "فشل إرسال الرسالة إلى {{target}}",
      sendFailed: "فشل إرسال الرسالة",
      sendingInputTo: "جارٍ إرسال الإدخال إلى {{target}}",
      sendingInput: "جارٍ إرسال الإدخال",
      inputSentTo: "تم إرسال الإدخال إلى {{target}}",
      inputSent: "تم إرسال الإدخال",
      sendInputFailedTo: "فشل إرسال الإدخال إلى {{target}}",
      sendInputFailed: "فشل إرسال الإدخال",
      starting: "جارٍ بدء {{target}}",
      processStarting: "جارٍ بدء العملية",
      started: "تم بدء {{target}}",
      processStarted: "تم بدء العملية",
      startFailed: "فشل بدء {{target}}",
      processStartFailed: "فشل بدء العملية",
      stopping: "جارٍ إيقاف {{target}}",
      processStopping: "جارٍ إيقاف العملية",
      stopped: "تم إيقاف {{target}}",
      processStopped: "تم إيقاف العملية",
      stopFailed: "فشل إيقاف {{target}}",
      processStopFailed: "فشل إيقاف العملية",
      restarting: "جارٍ إعادة تشغيل {{target}}",
      processRestarting: "جارٍ إعادة تشغيل العملية",
      restarted: "تمت إعادة تشغيل {{target}}",
      processRestarted: "تمت إعادة تشغيل العملية",
      restartFailed: "فشل إعادة تشغيل {{target}}",
      processRestartFailed: "فشل إعادة تشغيل العملية",
      inspecting: "جارٍ فحص {{target}}",
      processInspecting: "جارٍ فحص العملية",
      described: "العملية {{target}}",
      processDescribed: "تفاصيل العملية",
      describeFailed: "فشل فحص {{target}}",
      processDescribeFailed: "فشل فحص العملية",
      fetchingLogs: "جارٍ جلب السجلات من {{target}}",
      processFetchingLogs: "جارٍ جلب السجلات",
      logs: "سجلات {{target}}",
      processLogs: "سجلات العملية",
      logsFailed: "فشل جلب سجلات {{target}}",
      processLogsFailed: "فشل جلب السجلات",
      waitingFor: "في انتظار {{target}}",
      waiting: "في الانتظار",
      waitedFor: "اكتمل انتظار {{target}}",
      waited: "اكتمل الانتظار",
      waitFailedFor: "فشل انتظار {{target}}",
      waitFailed: "فشل الانتظار",
      jobs: "المهام في الخلفية",
      inbox: "صندوق الوارد",
      inboxPeek: "صندوق الوارد (معاينة)",
      agents: "الوكلاء",
      agentsFiltered: "الوكلاء ({{status}})",
      processes: "العمليات",
      cancelling: "جارٍ إلغاء {{target}}",
      cancellingJobs: "جارٍ إلغاء المهام",
      cancelled: "تم إلغاء {{target}}",
      jobsCancelled: "تم إلغاء المهام",
      cancelFailedFor: "فشل إلغاء {{target}}",
      cancelFailed: "فشل إلغاء المهام",
    },
    status: {
      running: "قيد التشغيل",
      completed: "مكتمل",
  ...
  settings: {
    ...
    voice: {
      ...
      microphone: {
        label: "الميكروفون",
        description: "مدخل الصوت المستخدم في الإملاء",
        systemDefault: "الافتراضي في النظام",
        deviceFallback: "ميكروفون {{index}}",
        deviceUnavailable: "الميكروفون المحدد غير متاح",
        accessLabel: "الوصول إلى الميكروفون",
        accessLabelsHidden: "اسمح بالوصول لعرض أسماء الميكروفونات",
        accessNoDevices: "لم يتم العثور على أي ميكروفون",
        accessUnavailable: "التقاط الصوت غير متاح هنا",
        accessError: "تعذر الوصول إلى الميكروفون: {{message}}",
        allowAccess: "السماح بالوصول",
        requesting: "جارٍ الطلب...",
        managedDescription: "يُدار مدخل الصوت بواسطة نظام التشغيل",
      },
      dictation: {
        title: "الإملاء",
        enable: "تفعيل الإملاء",
        ready: "جاهز",
        notReady: "غير جاهز",
        statusUnknown: "الحالة غير متاحة",
        offline: "اتصل بهذا المضيف لإعداد الإملاء",
        loading: "جارٍ تحميل إعدادات الإملاء...",
        restartRequired: "أعد تشغيل البرنامج الخفي للتطبيق",
        updateRequired: "حدّث البرنامج الخفي لإعداد الإملاء هنا",
        noHosts: "اتصل بمضيف لإعداد الإملاء",
        saveFailed: "تعذر تحديث إعدادات الإملاء: {{message}}",
        provider: {
          label: "التعرف على الكلام",
          description: "المكان الذي يُنسَخ فيه صوت الإملاء",
          local: "على هذا الجهاز (Parakeet)",
          openai: "واجهة OpenAI البرمجية",
        },
        language: {
          label: "اللغة",
          description: "اللغة المنطوقة للنسخ",
          placeholder: "ar",
          accessibilityLabel: "لغة الإملاء",
        },
      },
    },
    notifications: {
      ...
      playSound: "تشغيل صوت",
      playSoundHint: "تشغيل صوت عندما يحتاج وكيل إلى انتباهك",
      flash: "وميض أيقونة التطبيق",
      flashHint: "وميض أيقونة شريط المهام والعنوان عندما يحتاج وكيل إلى إدخال",
      test: "اختبار الإشعار",
    ...
    appearance: {
      ...
      hostPerformance: {
        title: "أداء المضيف",
        description: "عرض استخدام المعالج والذاكرة ومعالج الرسومات في الشريط الجانبي",
      },
      sidebar: {
    ...
    host: {
      webPush: {
        title: "إشعارات الويب الدفعية",
        label: "إشعارات الخلفية",
        disabledHint: "تلقي إشعارات في الخلفية عند انتهاء الوكلاء أو حاجتهم إلى انتباه.",
        unsupportedInsecure: "تتطلب إشعارات الويب الدفعية سياقًا آمنًا (HTTPS أو localhost).",
        unsupportedIos: "على iOS، تتطلب إشعارات الويب الدفعية إضافة Paseo إلى الشاشة الرئيسية.",
        unsupportedBrowser: "متصفحك لا يدعم إشعارات الويب الدفعية.",
        permissionDenied:
          "تم حظر إذن الإشعارات في إعدادات متصفحك. يرجى السماح بالإشعارات لهذا الموقع.",
        updateRequired: "يلزم تحديث برنامج خادم المضيف لدعم إشعارات الويب الدفعية.",
        disconnected: "المضيف غير متصل. اتصل لتفعيل الإشعارات.",
        enabledHint: "إشعارات الدفع في الخلفية نشطة لهذا المضيف.",
        enablingHint: "جارٍ تفعيل إشعارات الويب الدفعية…",
        disablingHint: "جارٍ تعطيل إشعارات الويب الدفعية…",
        testingHint: "جارٍ إرسال إشعار تجريبي…",
        enable: "تفعيل",
        disable: "تعطيل",
        testTitle: "إشعار تجريبي",
        testHint: "أرسل إشعارًا تجريبيًا للتحقق من التسليم على هذا الجهاز.",
  ...
  hostPerformance: {
    ...
    ram: "RAM",
    devices: "{{count}} أجهزة",
    busiestGpu: "معالج الرسومات الأكثر انشغالاً",
    usedOf: "{{used}} / {{total}}",
    stale: "قديم",
    errorTitle: "تعذر تحميل أداء المضيف",
    hostUnavailable: "اتصل بهذا المضيف لرؤية الأداء",
    hostUpgradeRequired: "قم بتحديث برنامج المضيف لعرض مقاييس الأداء",
    retry: "إعادة المحاولة",
    noGpu: "لم يتم اكتشاف معالج رسومات",
    gpuUnavailable: "مقاييس معالج الرسومات غير متوفرة",
    memoryUnavailable: "الذاكرة غير متوفرة",
