export const en = {
  ...
  workspace: {
    ...
    header: {
      actions: {
        ...
        saveLayoutTemplate: "Save layout as template for new workspaces",
      ...
      toasts: {
        ...
        layoutTemplateSaved: "Layout saved — new workspaces in this project will open with it",
        layoutTemplateCleared: "Saved layout template cleared",
  ...
  panels: {
    ...
    side: {
      label: "Side",
      subtitle: "Side chat",
      tooltip: "Side chat linked to active agent",
      emptyTitle: "No main agent selected",
      emptyDescription: "Select or focus an agent tab in the main workspace to chat with Side.",
      capabilityMissing: "Update the host to use Side chat.",
      ...
      sendingToMain: "Sending...",
      sentToMain: "Sent to main agent",
      failedToSendToMain: "Failed to send to main agent",
      retry: "Retry",
      loadError: "Failed to load side chat",
      userLabel: "You",
      assistantLabel: "Side",
      providerLabel: "Provider",
      unsupportedMainProvider: "Main agent provider is not supported for Side. Choose a provider:",
      chooseProvider: "Choose a provider",
      selectProviderPrompt: "Select a provider to start Side chat",
    },
  },
  toolCallDetails: {
    error: "Error",
  ...
  hub: {
    title: {
      sendingTo: "Sending message to {{target}}",
      sending: "Sending message",
      sentTo: "Message sent to {{target}}",
      sent: "Message sent",
      sendFailedTo: "Failed to send message to {{target}}",
      sendFailed: "Failed to send message",
      sendingInputTo: "Sending input to {{target}}",
      sendingInput: "Sending input",
      inputSentTo: "Input sent to {{target}}",
      inputSent: "Input sent",
      sendInputFailedTo: "Failed to send input to {{target}}",
      sendInputFailed: "Failed to send input",
      starting: "Starting {{target}}",
      processStarting: "Starting process",
      started: "Started {{target}}",
      processStarted: "Process started",
      startFailed: "Failed to start {{target}}",
      processStartFailed: "Failed to start process",
      stopping: "Stopping {{target}}",
      processStopping: "Stopping process",
      stopped: "Stopped {{target}}",
      processStopped: "Process stopped",
      stopFailed: "Failed to stop {{target}}",
      processStopFailed: "Failed to stop process",
      restarting: "Restarting {{target}}",
      processRestarting: "Restarting process",
      restarted: "Restarted {{target}}",
      processRestarted: "Process restarted",
      restartFailed: "Failed to restart {{target}}",
      processRestartFailed: "Failed to restart process",
      inspecting: "Inspecting {{target}}",
      processInspecting: "Inspecting process",
      described: "Process {{target}}",
      processDescribed: "Process details",
      describeFailed: "Failed to inspect {{target}}",
      processDescribeFailed: "Failed to inspect process",
      fetchingLogs: "Fetching logs from {{target}}",
      processFetchingLogs: "Fetching logs",
      logs: "Logs from {{target}}",
      processLogs: "Process logs",
      logsFailed: "Failed to get logs from {{target}}",
      processLogsFailed: "Failed to get logs",
      waitingFor: "Waiting for {{target}}",
      waiting: "Waiting",
      waitedFor: "Waited for {{target}}",
      waited: "Wait complete",
      waitFailedFor: "Wait failed for {{target}}",
      waitFailed: "Wait failed",
      jobs: "Background jobs",
      inbox: "Inbox",
      inboxPeek: "Inbox (peek)",
      agents: "Agents",
      agentsFiltered: "Agents ({{status}})",
      processes: "Processes",
      cancelling: "Cancelling {{target}}",
      cancellingJobs: "Cancelling jobs",
      cancelled: "Cancelled {{target}}",
      jobsCancelled: "Jobs cancelled",
      cancelFailedFor: "Failed to cancel {{target}}",
      cancelFailed: "Failed to cancel jobs",
    },
    status: {
      running: "Running",
      completed: "Complete",
  ...
  settings: {
    ...
    voice: {
      ...
      microphone: {
        label: "Microphone",
        description: "Audio input used for dictation",
        systemDefault: "System default",
        deviceFallback: "Microphone {{index}}",
        deviceUnavailable: "Selected microphone unavailable",
        accessLabel: "Microphone access",
        accessLabelsHidden: "Allow access to see microphone names",
        accessNoDevices: "No microphone detected",
        accessUnavailable: "Microphone capture is unavailable here",
        accessError: "Couldn't access the microphone: {{message}}",
        allowAccess: "Allow access",
        requesting: "Requesting...",
        managedDescription: "Audio input is managed by the operating system",
      },
      dictation: {
        title: "Dictation",
        ...
        offline: "Connect to this host to configure dictation",
        loading: "Loading dictation settings...",
        restartRequired: "Restart the daemon to apply",
        updateRequired: "Update the daemon to configure dictation here",
        noHosts: "Connect a host to configure dictation",
        saveFailed: "Couldn't update dictation settings: {{message}}",
        provider: {
          label: "Speech recognition",
          description: "Where dictation audio is transcribed",
          local: "On this device (Parakeet)",
          openai: "OpenAI API",
        },
        language: {
          label: "Language",
          description: "Spoken language for transcription",
          placeholder: "en",
    ...
    notifications: {
      ...
      playSoundHint: "Play a sound when an agent needs attention",
      flash: "Flash app icon",
      flashHint: "Flash the taskbar icon and title when an agent needs input",
