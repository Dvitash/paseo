...
export const ja: TranslationResources = {
  ...
  panels: {
    ...
    side: {
      label: "Side",
      subtitle: "Side チャット",
      tooltip: "アクティブなエージェントにリンクされた Side チャット",
      emptyTitle: "メインエージェントが選択されていません",
      emptyDescription:
        "Side とチャットするには、メインワークスペースでエージェントタブを選択またはフォーカスしてください。",
      capabilityMissing: "Side チャットを使用するにはホストを更新してください。",
      linkedTo: "{{title}} にリンク中",
      ...
      sendToMain: "メインに送信",
      sendingToMain: "送信中...",
      sentToMain: "メインエージェントに送信しました",
      failedToSendToMain: "メインエージェントへの送信に失敗しました",
      retry: "再試行",
      loadError: "Side チャットの読み込みに失敗しました",
      userLabel: "あなた",
      assistantLabel: "Side",
      providerLabel: "プロバイダー",
      unsupportedMainProvider:
        "メインエージェントのプロバイダーは Side でサポートされていません。プロバイダーを選択してください:",
      chooseProvider: "プロバイダーを選択",
      selectProviderPrompt: "Side チャットを開始するプロバイダーを選択してください",
    },
  },
  toolCallDetails: {
    error: "エラー",
  ...
  hub: {
    title: {
      sendingTo: "{{target}} にメッセージを送信中",
      sending: "メッセージを送信中",
      sentTo: "{{target}} にメッセージを送信しました",
      sent: "メッセージを送信しました",
      sendFailedTo: "{{target}} へのメッセージ送信に失敗しました",
      sendFailed: "メッセージの送信に失敗しました",
      sendingInputTo: "{{target}} に入力を送信中",
      sendingInput: "入力を送信中",
      inputSentTo: "{{target}} に入力を送信しました",
      inputSent: "入力を送信しました",
      sendInputFailedTo: "{{target}} への入力送信に失敗しました",
      sendInputFailed: "入力の送信に失敗しました",
      starting: "{{target}} を起動中",
      processStarting: "プロセスを起動中",
      started: "{{target}} を起動しました",
      processStarted: "プロセスを起動しました",
      startFailed: "{{target}} の起動に失敗しました",
      processStartFailed: "プロセスの起動に失敗しました",
      stopping: "{{target}} を停止中",
      processStopping: "プロセスを停止中",
      stopped: "{{target}} を停止しました",
      processStopped: "プロセスを停止しました",
      stopFailed: "{{target}} の停止に失敗しました",
      processStopFailed: "プロセスの停止に失敗しました",
      restarting: "{{target}} を再起動中",
      processRestarting: "プロセスを再起動中",
      restarted: "{{target}} を再起動しました",
      processRestarted: "プロセスを再起動しました",
      restartFailed: "{{target}} の再起動に失敗しました",
      processRestartFailed: "プロセスの再起動に失敗しました",
      inspecting: "{{target}} を確認中",
      processInspecting: "プロセスを確認中",
      described: "プロセス {{target}}",
      processDescribed: "プロセスの詳細",
      describeFailed: "{{target}} の確認に失敗しました",
      processDescribeFailed: "プロセスの確認に失敗しました",
      fetchingLogs: "{{target}} からログを取得中",
      processFetchingLogs: "ログを取得中",
      logs: "{{target}} のログ",
      processLogs: "プロセスログ",
      logsFailed: "{{target}} のログ取得に失敗しました",
      processLogsFailed: "ログの取得に失敗しました",
      waitingFor: "{{target}} を待機中",
      waiting: "待機中",
      waitedFor: "{{target}} の待機完了",
      waited: "待機完了",
      waitFailedFor: "{{target}} の待機に失敗しました",
      waitFailed: "待機に失敗しました",
      jobs: "バックグラウンドジョブ",
      inbox: "受信トレイ",
      inboxPeek: "受信トレイ (プレビュー)",
      agents: "エージェント",
      agentsFiltered: "エージェント ({{status}})",
      processes: "プロセス",
      cancelling: "{{target}} をキャンセル中",
      cancellingJobs: "ジョブをキャンセル中",
      cancelled: "{{target}} をキャンセルしました",
      jobsCancelled: "ジョブをキャンセルしました",
      cancelFailedFor: "{{target}} のキャンセルに失敗しました",
      cancelFailed: "ジョブのキャンセルに失敗しました",
    },
    status: {
      running: "実行中",
      completed: "完了",
  ...
  settings: {
    ...
    voice: {
      ...
      microphone: {
        label: "マイク",
        description: "音声入力に使用するオーディオ入力",
        systemDefault: "システム既定",
        deviceFallback: "マイク {{index}}",
        deviceUnavailable: "選択したマイクを利用できません",
        accessLabel: "マイクへのアクセス",
        accessLabelsHidden: "マイク名を表示するにはアクセスを許可してください",
        accessNoDevices: "マイクが見つかりません",
        accessUnavailable: "この環境では音声入力を利用できません",
        accessError: "マイクにアクセスできませんでした: {{message}}",
        allowAccess: "アクセスを許可",
        requesting: "要求中...",
        managedDescription: "オーディオ入力はオペレーティングシステムが管理します",
      },
      dictation: {
        title: "音声入力",
        enable: "音声入力を有効にする",
        ready: "準備完了",
        notReady: "準備未完了",
        statusUnknown: "状態を取得できません",
        offline: "音声入力を設定するにはこのホストに接続してください",
        loading: "音声入力の設定を読み込み中...",
        restartRequired: "適用するにはデーモンを再起動してください",
        updateRequired: "ここで音声入力を設定するにはデーモンを更新してください",
        noHosts: "音声入力を設定するにはホストに接続してください",
        saveFailed: "音声入力の設定を更新できませんでした: {{message}}",
        provider: {
          label: "音声認識",
          description: "音声入力の音声を文字起こしする場所",
          local: "このデバイス上（Parakeet）",
          openai: "OpenAI API",
        },
        language: {
          label: "言語",
          description: "文字起こしに使用する話し言葉",
          placeholder: "ja",
          accessibilityLabel: "音声入力の言語",
        },
      },
    },
    notifications: {
      ...
      playSound: "サウンドを再生",
      playSoundHint: "エージェントが注意を必要とするときにサウンドを再生します",
      flash: "アプリアイコンを点滅",
      flashHint: "エージェントが入力を必要とするときにタスクバーアイコンとタイトルを点滅させます",
      test: "通知をテスト",
    ...
    appearance: {
      ...
      hostPerformance: {
        title: "ホストのパフォーマンス",
        description: "サイドバーにCPU、メモリ、GPUの使用率を表示します",
      },
      sidebar: {
        title: "サイドバー",
  ...
  hostPerformance: {
    ...
    ram: "RAM",
    devices: "{{count}} デバイス",
    busiestGpu: "最も使用中のGPU",
    usedOf: "{{used}} / {{total}}",
    stale: "古いデータ",
    errorTitle: "ホストのパフォーマンスを読み込めません",
    hostUnavailable: "パフォーマンスを表示するにはこのホストに接続してください",
    hostUpgradeRequired: "パフォーマンス指標を表示するにはホストデーモンを更新してください",
    retry: "再試行",
    noGpu: "GPUが検出されませんでした",
    gpuUnavailable: "GPU指標を利用できません",
    memoryUnavailable: "メモリ情報を利用できません",
