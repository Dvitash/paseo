...
export const syntaxRoleTags: ReadonlyArray<{ tag: Tag; role: HighlightStyle }> = [
  ...
  { tag: tags.arithmeticOperator, role: "operator" },
  { tag: tags.bitwiseOperator, role: "operator" },
  { tag: tags.compareOperator, role: "operator" },
  { tag: tags.logicOperator, role: "operator" },
  { tag: tags.punctuation, role: "punctuation" },
  { tag: tags.bracket, role: "punctuation" },
  { tag: tags.paren, role: "punctuation" },
  { tag: tags.squareBracket, role: "punctuation" },
  { tag: tags.brace, role: "punctuation" },
  { tag: tags.separator, role: "punctuation" },
  { tag: tags.regexp, role: "regexp" },
  { tag: tags.annotation, role: "meta" },
  { tag: tags.meta, role: "meta" },
  { tag: tags.inserted, role: "tag" },
  { tag: tags.deleted, role: "keyword" },
